#' @title This function simulates (generates) categorical data sets by given a Confirmatory Factor Analysis model.
...
sim.categoric<-function(nd=10, ss=100, fcors, loading, f.loc, threshold ){
  ...
  for(n.d in 1:nd){
    ...
    # So far contionues data were generated. After here categorical data was simulated.
    ...
    write.table(item.scores, file=paste(f.loc,"/C_Data_",n.d,".dat", sep=""), sep = "\t", col.names = FALSE, row.names = FALSE,quote = FALSE)
  ...
  print(loading)
  print("Categorical data was generated by using following thresholds")
  print(threshold)
  sink()
